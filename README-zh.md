...
修订 [2026-09-15]（Owner 法令「至少是双语的」）：本文件转为中文版 `README-zh.md`，英文正典移入 `README.md`（参照 unipty 的双语结构）；两份文件事实必须同步演化。
-->
...
[English](README.md) | 简体中文 · 官网 <https://skill-creator.jixoai.com>
