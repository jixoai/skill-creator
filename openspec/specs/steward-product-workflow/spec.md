...
This workflow MUST use the DSH client composition from the preceding change. Original Manager views MAY remain Svelte islands; a wholesale framework rewrite is not required.
