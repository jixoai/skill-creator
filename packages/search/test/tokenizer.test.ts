 ...
 *
 * 2026-09-21 平移自主仓 test/skill-search-tokenizer.test.ts（jixoai-search-core 1.5）；
 * import 改指包内实现（../src/tokenizer.js），期望表逐字一致。
 */
import { afterEach, describe, expect, it, vi } from "vitest";
import { createSkillTokenizer, TOKENIZER_VERSION } from "../src/tokenizer.js";
